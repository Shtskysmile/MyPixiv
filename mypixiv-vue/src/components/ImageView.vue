...
export default {
  ...
  methods: {
    ...
    async toggleLike() {
      ...
      try {
        const endpoint = this.isLiked ? '/user/unlikeContribution' : '/user/likeContribution';
        const params = new URLSearchParams();
    ...
    async toggleFavorite() {
      ...
      try {
        const endpoint = this.isFavorite ? '/user/unfavoriteContribution' : '/user/favoriteContribution';
        const params = new URLSearchParams();
        params.append('contributionId', this.contribution.contributionId);
    ...
    async submitComment(commentText) {
      ...
      try {
        ...
        const response = await request.post('/user/commentContribution', params);
    ...
    async deleteComment(comment) {
      ...
      try {
        ...
        const response = await request.post('/communityAdmin/deleteComment', params);
    ...
    async approveWork() {
      ...
      try {
        ...
        const res = await request.post('/communityAdmin/approveContribution', params);
    ...
    async dismissWork() {
      ...
      try {
        ...
        const res = await request.post('/communityAdmin/dismissContribution', params);
    ...
    async blockWork() {
      ...
      try {
        ...
        const res = await request.post('/communityAdmin/blockContribution', params);
    ...
    async unblockWork() {
      ...
      try {
        ...
        const res = await request.post('/communityAdmin/unblockContribution', params);
